...
void ProjectionX::setWireframe(bool b){
    this->wireframe = b;
}
void ProjectionX::update(){
    updateGL();
}
void ProjectionX::setModel(Model *m){
    this->model = m;
}
...
//    glEnable(GL_LIGHT0);
    ...
    GLfloat qaAmbL[] = {0.0,0.0,0.0,1.0};
    GLfloat qaDifL[] = {1.0,1.0,1.0,1.0};
    ...
    GLfloat qaLpos[] = {0.0,0.0,1.0,1.0};
