...
QSize ProjectionZ::sizeHint() const
{
    return QSize(400, 400);
}

void ProjectionZ::setWireframe(bool b){
    this->wireframe = b;
}
void ProjectionZ::update(){
    updateGL();
}
void ProjectionZ::setModel(Model *m){
    this->model = m;
}
void ProjectionZ::setScale(int factor){
    if(factor != 1){
        scl = factor;
...
void ProjectionZ::resizeGL(int width, int height)
{
