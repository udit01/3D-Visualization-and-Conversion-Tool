...
Model* SampleModels::Axes(float side)
{
    ...
    copy(o,o+3,points); copy(a, a+3, points+3); copy(b, b+3, points+6); copy(c, c+3, points+9);

    // float * base = new float[3*4];
    // copy(a, a+3, base);copy(b, b+3, base+3);copy(c, c+3, base+2*3);copy(d, d+3, base+3*3);

    float* f1 = new float[9];
    copy(a, a+3, f1); copy(b, b+3, f1+3); copy(o, o+3, f1+6);
    float* f2 = new float[9];
    copy(b, b+3, f2); copy(c, c+3, f2+3); copy(o, o+3, f2+6);
    float* f3 = new float[9];
    copy(c, c+3, f3); copy(a, a+3, f3+3); copy(o, o+3, f3+6);
